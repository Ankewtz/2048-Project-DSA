...
public class Game2048View extends JPanel {
    ...
    private void setupMainGamePanel() {
        ...
        mainGamePanel.setLayout(new GridLayout(4, 4, 10, 10));
    ...
    private void setupAutoplayButton() {
        JButton autoplayButton = new JButton("Autoplay");
        autoplayButton.setPreferredSize(new Dimension(120, 40));
        ...
        autoplayButton.setFont(new Font("Arial", Font.BOLD, 16));
        autoplayButton.addActionListener(game2048Controller);
    ...
    public JPanel lostWinView(String title, String buttonLabel) {
        ...
        JPanel textPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 30, 30));
        ...
        actionButton.addActionListener(game2048Controller);
        ...
        quitButton.addActionListener(game2048Controller);
    ...
    public void createGameButton(int x, int y) {
        ...
        gameButtons[x][y].setText(String.valueOf(gameButtonIndexes[x][y]));
